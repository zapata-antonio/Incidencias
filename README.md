...
|---|---:|---|---|---|
| Redes | 26 | IP Overlap en VNet Peering | Diagnóstico de solapamiento CIDR y corrección de address space | [Abrir Lab 26](../Lab-26-Incidencia-Solapamiento-de-IPs-en-VNet-Peering) |
